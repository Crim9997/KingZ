...
class General(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="chwerreb X Invite & Support!",
      description=
      f"> <:icons_plus:1328966531140288524> **[chwerreb X - Invite Bot](https://discord.com/oauth2/authorize?client_id=1313160406117646417&permissions=8&integration_type=0&scope=bot+applications.commands)**\n> <:icons_plus:1328966531140288524> **[chwerreb X - Support](https://discord.gg/codexdev)**",
      color=0x0ba7ff)
